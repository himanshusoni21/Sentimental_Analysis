...
class DB_Operations:
    ...
    def create_db_connection(self,database_name):
        ...
        self.logger.log(file,'Entered create_db_connection() method of DB_Operation class of db_operations package')
        file.close()
    ...
    def create_collection(self,db_object):
        file = open('Training_Logs/General_Log.txt', 'a+')
        self.logger.log(file,'Entered create_collection() method of DB_Operation class of db_operations package')
        file.close()
    ...
    def insertion_GoodRawData_into_collection(self,collection_object):
        file = open('Training_Logs/General_Log.txt', 'a+')
        self.logger.log(file, 'Entered insertionGoodData_into_collection() method of DB_Operation class of db_operations package')
        file.close()
    ...
    def selectDataFromCollection_into_csv(self, collection_object):
        file = open('Training_Logs/General_Log.txt', 'a+')
        self.logger.log(file,'Entered selectDataFromCollection_into_csv() method of DB_Operation class of db_operations package')
        file.close()
