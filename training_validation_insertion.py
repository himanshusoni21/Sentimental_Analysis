...
class Train_Validation:
    def __init__(self,fileobject,batch_file_path):
    ...
    def training_validation(self):
        try:
            ...
            self.logger_object.log(self.file_object,'Start of Database Creation,Collection Creation,Insertion and Selection')
